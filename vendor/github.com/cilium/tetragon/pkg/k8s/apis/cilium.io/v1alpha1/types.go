...
type ArgSelector struct {
	...
	// +kubebuilder:validation:Enum=Equal;NotEqual;Prefix;NotPrefix;Postfix;NotPostfix;GreaterThan;LessThan;GT;LT;Mask;SPort;NotSPort;SPortPriv;NotSportPriv;DPort;NotDPort;DPortPriv;NotDPortPriv;SAddr;NotSAddr;DAddr;NotDAddr;Protocol;Family;State;InMap;NotInMap;CapabilitiesGained;InRange;NotInRange
	// Filter operation.
	Operator string `json:"operator"`
	// Value to compare the argument against.
...
type ActionSelector struct {
	// +kubebuilder:validation:Enum=Post;FollowFD;UnfollowFD;Sigkill;CopyFD;Override;GetUrl;DnsLookup;NoPost;Signal;TrackSock;UntrackSock;NotifyEnforcer;CleanupEnforcerNotification;Set;UpdateMap
	// Action to execute.
	...
	// +kubebuilder:validation:Optional
	// An arg value for the raw access
	ArgOffset uint32 `json:"argOffset"`
	// +kubebuilder:validation:Optional
	// An arg size for the raw access
	ArgSize uint32 `json:"argSize"`
	// +kubebuilder:validation:Optional
