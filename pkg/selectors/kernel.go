...
func parseMatchArg(k *KernelSelectorState, arg *v1alpha1.ArgSelector, sig []v1alpha1.KProbeArg, ty uint32) error {
	...
	case SelectorOpEQ, SelectorOpNEQ:
		switch ty {
		case gt.GenericFdType, gt.GenericFileType, gt.GenericPathType, gt.GenericStringType, gt.GenericCharBuffer, gt.GenericLinuxBinprmType, gt.GenericDataLoc, gt.GenericNetDev, gt.GenericBpfMap:
...
func ParseMatchAction(k *KernelSelectorState, action *v1alpha1.ActionSelector, actionArgTable *idtable.Table) error {
	...
	case ActionTypeUpdateMap:
		WriteSelectorUint32(&k.data, action.ArgIndex)
		WriteSelectorUint32(&k.data, action.ArgOffset)
		WriteSelectorUint32(&k.data, action.ArgSize)
	default:
